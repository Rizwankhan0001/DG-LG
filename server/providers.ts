...
export function integrations():Integration[] { return [
 ...
 {id:'resend',name:'Resend',configured:!!process.env.RESEND_API_KEY&&!!process.env.OUTREACH_FROM,enabled:process.env.OUTREACH_ENABLED==='true',description:'Send emails you review, using your verified business domain.',keys:['RESEND_API_KEY','OUTREACH_FROM','OUTREACH_ENABLED'],url:'https://resend.com/api-keys'}
 ]; }
