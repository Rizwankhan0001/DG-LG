...
const source=['package.json','package-lock.json','tsconfig.json','vite.config.ts','playwright.config.ts','index.html','Dockerfile','compose.yaml','Caddyfile','railway.json','render.yaml','vercel.json','.vercelignore','.env.example','.gitignore','.dockerignore','README.md','DEPLOYMENT.md','BUSINESS_ANALYSIS.md','BACKEND_SETUP.md','CAMPAIGNS.md','DATA_SETUP.md','src','server','api','shared','public','scripts','tests','data/catalog.json','data/researched-leads.json','data/RESEARCH.md','data/research-refresh-report.json'];
